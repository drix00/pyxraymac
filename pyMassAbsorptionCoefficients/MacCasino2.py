...
def MACS_ZALUZEC(wavelength_A, atomicNumberAbsorbeur):
    """
    ...
    @param l electron wavelength in Angstrom.
    @param absorbeur atomic number of the absorber element.
    @return mass absorption coefficient in ??.
    @retval -1.0 if the inputs are out of range of the model.
    """
#{
#    double E, c, n, c_abs, energy;
#
#    E = 12398.1 / l; /*en ev*/
#    energy = E;
#    c = 0.;
...
#    if ((energy < 185) && (absorbeur != 1))
#    {
#        c_abs = MACSTOTAL(l, absorbeur);
#        return (static_cast<float>(c_abs));
#    }
#
#    if (energy > 1487 && absorbeur != 1)
#    {
#        c_abs = MACSTOTAL(l, absorbeur);
#        return (static_cast<float>(c_abs));
#    }
...
#            if (E > 1487)
#            {
#                SPECIAL_EQUATIONS(E / 1000.0, absorbeur, &c_abs);
#                return (static_cast<float>(c_abs));
#            }
#            if (E > 679 && E <= 1487)
#            {
...
#            if (c == 0.0)
#            {
#                printf("\n\nerreur dans la fonction COEFF_ABS H");
#                exit(1);
#            }
#            else
#                c_abs = c * pow((12398.1 / E), n);
#            if (c_abs < 0.0)
#                c_abs = 0.0;
#            return (static_cast<float>(c_abs));
#        }
...
#            if (E <= 556) /****/
#            {
#                c_abs = -7.059e-4 * pow(l, 4) - 4.815e-2 * pow(l, 3)
#                        + 25.79 * SQR(l) - 3.644e2 * l + 1801.;
#
#                if (c_abs < 0.0)
#                    c_abs = 0.0;
#
...
#            if (E <= 637)
#            {
#                c_abs = -0.2407 * pow(l, 3) + 39.83 * SQR(l) - 527. * l + 2278.;
#                if (c_abs < 0.0)
#                    c_abs = 0.0;
#
#                return (static_cast<float>(c_abs));
...
#            if (E <= 776)
#            {
#                c_abs = -4.411e-4 * pow(l, 5) + 9.878e-2 * pow(l, 4)
#                        - 8.218 * pow(l, 3) + 302. * SQR(l) - 4.466e3 * l
#                        + 29660.;
#                if (c_abs < 0.0)
#                    c_abs = 0.0;
#
...
def SPECIAL_EQUATIONS(energy_eV, atomicNumber, macs):
    """
    Equations used in MACS_ZALUZEC.
...
#        if (E <= 2.0 && E >= 1)
#        {
#            *macs = 3.0353 * pow(l, 0.01460);
#            return;
#        }
#        if (E <= 3.5 && E >= 1)
#        {
#            *macs = 3.5 * pow(l, 0.05890);
#            return;
#        }
#        if (E <= 4.0 && E >= 1)
#        {
#            *macs = 3.5 * pow(l, 0.07434);
#            return;
#        }
#        if (E <= 6.0 && E >= 1)
#        {
#            *macs = 2.937 * pow(l, 0.27795);
#            return;
#        }
#        if (E <= 9.2 && E >= 1)
#        {
#            *macs = 0.627 * pow(l, .4231);
#            return;
#        }
#        if (E <= 40.0 && E >= 1)
#        {
#            *macs = 0.089 * pow(l, .44767);
#            return;
#        }
#    }
#    if (z == 2)
...
#        if (E >= 3.7 && E <= 6.0)
#        {
#            *macs = 3.7 * pow(l, .10107);
#            return;
#        }
#        if (E <= 9.5)
#        {
#            *macs = 2.44950 * pow(l, .19040);
#            return;
#        }
#        if (E <= 18.)
#        {
#            *macs = 1.1265 * pow(l, .21026);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 0.08672 * pow(l, .18714);
#            return;
#        }
#    }
#    if (z == 3)
...
#        if (E >= 5.90 && E <= 8.80)
#        {
#            *macs = 5.9 * pow(l, .18233);
#            return;
#        }
#        if (E <= 12.50)
#        {
#            *macs = 4.17123 * pow(l, 0.26263);
#            return;
#        }
#        if (E <= 19.20)
#        {
#            *macs = 1.97884 * pow(l, .26156);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = .2920 * pow(l, .22601);
#            return;
#        }
#    }
#    if (z == 4)
...
#        if (E <= 19.80)
#        {
#            *macs = 5.53694 * pow(l, .38371);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 0.63152 * pow(l, .29211);
#            return;
#        }
#    }
#    if (z == 5)
...
#        if (E >= 10.2 && E <= 15.)
#        {
#            *macs = 10.2 * pow(l, .62897);
#            return;
#        }
#        if (E <= 21.)
#        {
#            *macs = 6.84584 * pow(l, .49970);
#            return;
#        }
#        if (E <= 31.)
#        {
#            *macs = 3.83941 * pow(l, .40524);
#            return;
#        }
#        if (E >= 40.)
#        {
#            *macs = .63152 * pow(l, .29211);
#            return;
#        }
#    }
#    if (z == 6)
...
#        if (E >= 13. && E <= 21.)
#        {
#            *macs = 13. * pow(l, 1.10987);
#            return;
#        }
#        if (E <= 27.5)
#        {
#            *macs = 9.94906 * pow(l, .74709);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 2.588 * pow(l, .40943);
#            return;
#        }
#    }
#    if (z == 7)
...
#        if (E >= 15. && E < 21.)
#        {
#            *macs = 15. * pow(l, 1.4640);
#            return;
#        }
#        if (E <= 30.)
#        {
#            *macs = 12.96310 * pow(l, 1.06418);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 6.26451 * pow(l, .60023);
#            return;
#        }
#    }
#    if (z == 8)
...
#        if (E >= 17.2 && E <= 25.)
#        {
#            *macs = 17.2 * pow(l, 1.83450);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 13.21194 * pow(l, 1.07154);
#            return;
#        }
#    }
#    if (z == 9)
...
#        if (E >= 20. && E <= 28.5)
#        {
#            *macs = 20.0 * pow(l, 2.41791);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 14.85851 * pow(l, 1.19931);
#            return;
#        }
#    }
#    if (z == 10)
...
#        if (E >= 23. && E <= 30.)
#        {
#            *macs = 23. * pow(l, 3.28063);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 19.86943 * pow(l, 1.79454);
#            return;
#        }
#    }
#    if (z == 11)
...
#        if (E <= 25. && E <= 30.)
#        {
#            *macs = 25. * pow(l, 3.51621);
#            return;
#        }
#        if (E <= 40.)
#        {
#            *macs = 22.51741 * pow(l, 2.05417);
#            return;
#        }
#    }
#    if (z == 12)
...
#    if (z == 1)
#    {
#        float absp = MACS_ZALUZEC(12.3981f / E, z);
#        return (absp);
#    }
#
#    // for INI File
...
#
#    CString sIniFilePath = sModFileName.Right(
#            sModFileName.GetLength() - sModFileName.Find('\\'));
#    sIniFilePath.MakeReverse();
#
#    CString Path = sIniFilePath + "INT\\" + "kcoeff.prn";
#    CString Path2 = sIniFilePath + "INT\\" + "lcoeff.prn";
#
#    fstream kcoeff;
#    fstream lcoeff;
#    kcoeff.open(LPCTSTR(Path), ios::in);
#    lcoeff.open(LPCTSTR(Path2), ios::in);
#
#    if (!kcoeff.is_open() || !lcoeff.is_open())
#    {
#        MessageBox(NULL, "Kcoeff.prn or Lcoeff.prn not found!", "Error!",
#                   MB_OK);
#        return 0;
#    }
#
...
#    }
#
#    kcoeff.seekg(0, ios::beg);
#    lcoeff.seekg(0, ios::beg);
#
#    int i = 0;
#    int emin = i;
#    int emax = i + 1;
...
#    double energie[14] = {0.183, 0.277, 0.392, 0.452, 0.525, 0.573, 0.637,
#                          0.677, 0.705, 0.776, 0.848, 0.852, 0.930, 1.012};
#    // Original values
#    // double energie[14] ={0.185, 0.281, 0.392, 0.452, 0.525, 0.573, 0.637, 0.677, 0.705, 0.776, 0.849, 0.852, 0.930, 1.012};
#    int position[14][2] = { {0, 1}, {0, 2}, {0, 3}, {1, 1}, {0, 4}, {1, 3}, {1,
#                                                                             4},
#                           {0, 5}, {1, 5}, {1, 6}, {0, 6}, {1, 7}, {1, 8},
#                           {1, 9}};
#
#    if ((E >= 0.183f) && (E <= 1.012f))
#    {
...
#    }
#
#    int posfmin = position[emin][0];
#    int posfmax = position[emax][0];
#    int poscmin = position[emin][1];
#    int poscmax = position[emax][1];
#    int posl = z - 2;
#
#    const int kcol = 6;
#    const int lcol = 9;
...
#        {
#            for (int j = 1; j <= poscmin; j++)
#            {
#                kcoeff >> absmin;
#            }
#
#            float bidon;
#            for (int j = poscmin; j <= kcol; j++)
#            {
#                kcoeff >> bidon;
#            }
#        }
...
#        for (int i = 1; i <= posl; i++)
#        {
#            for (int j = 1; j <= poscmax; j++)
#            {
#                kcoeff >> absmax;
#            }
#
#            float bidon;
#            for (int j = poscmax; j <= kcol; j++)
#            {
#                kcoeff >> bidon;
#            }
#        }
...
#    if (ffitfener == 0)
#    {
#        absp = ((absmax - absmin) / (energie[emax] - energie[emin]))
#                * (E - energie[emin]) + absmin;
#    }
#    else
#    {
#        // Fit exponentiel a faible energie.
#        absp = exp(
#                ((log(absmax) - log(absmin))
#                        / (log(energie[emax]) - log(energie[emin])))
#                        * (log(E) - log(energie[emin])) + log(absmin));
#    }
#
    return absp
...
def MACSTOTAL(energy_keV, atomicNumber):
    ...
    @param l electron energy in keV.
    @param z atomic number of the absorber
    @return mass absorption coefficient in ??.
    """
...
#            cmult = 0.858;
#        if ((E < Ec[2]) && (E > Ec[3]))
#            cmult = (0.8933 - z * 8.29e-3 + pow(z, 2) * 6.38e-5);
#    }
#    if ((E < Ec[3]) && (E > Ec[4]))
#    {
#        if (atomicNumber < 30)
...
#    for (i = 0; i <= 4; i++)
#        for (j = 0; j <= 5; j++)
#            Ctot[i] += cmult * C[i][j] * pow(z, j);
#    for (i = 0; i <= 3; i++)
#        ntot += n[i] * pow(z, i);
#    for (i = 0; i <= 4; i++)
#        atot += a[i] * pow(z, i);
#    for (i = 0; i <= 4; i++)
#        btot += bmult * b[i] * pow(z, i);
#
#    if ((E < Ec[4]) && (E > Ec[5]))
#        CTOTAL = Ctot[0] * Ctot[1] * Ctot[2];
#    else if ((E < Ec[5]) && (E > Ec[6]))
#        CTOTAL = Ctot[0] * Ctot[1] * Ctot[3];
#    else if ((E < Ec[6]) && (E > Ec[7]))
#        CTOTAL = 0.95 * Ctot[0] * Ctot[1];
#    else if ((E < Ec[7]) && (E > Ec[8]))
#        CTOTAL = Ctot[0] * Ctot[1] * Ctot[4];
#    else
#        CTOTAL = Ctot[0];
#
#    MACSH = CTOTAL * pow(z, 4) / A[atomicNumber] * pow((12.397 / E), ntot)
#            * (1 - exp((-E * 1000 + btot) / atot));
#
#    if (E < Ec[9])
#        MACSH = 1.02 * CTOTAL * pow((12.397 / E), ntot) * CTOTAL * pow(z, 4)
#                / A[atomicNumber] * ((E * 1000 - cutoff) / (Ec[9] - cutoff));
#
#    return (static_cast<float>(MACSH));

def EFFICACITE(energy_keV, parameters):
    """
    ...
    @param energie x-ray energy in keV.
    @param a detector parameters.
...
#        {
#            if (a[1] != 0.0)
#                AAL = MACS_ZALUZEC(l, 13) * D_AL * a[1];
#            else
#                AAL = 0;
#
#            /*  APA=(CH_C6H6*MACS_ZALUZEC(l,1)+CC*MACS_ZALUZEC(l,6))*D_C*a[2]; */
#
#            if (a[2] != 0.0)
#                AFORMVAR = (0.0707f * MACS_ZALUZEC(l, 1)
#                        + 0.6063f * MACS_ZALUZEC(l, 6)
#                        + 0.3231f * MACS_ZALUZEC(l, 8)) * D_C * a[2];
#            else
#                AFORMVAR = 0;
#
#            if (a[3] != 0.0)
#                AAU = MACS_ZALUZEC(l, 79) * D_AU * a[3];
#            else
#                AAU = 0;
#
#            if (a[4] != 0.0)
#                ASID = MACS_ZALUZEC(l, 14) * D_SI * a[4];
#            else
#                ASID = 0;
#
#            if (a[5] != 0.0)
#                ABE = MACS_ZALUZEC(l, 4) * D_BE * a[5];
#            else
#                ABE = 0;
#
#            if (a[6] != 0.0)
#                AC = MACS_ZALUZEC(l, 6) * D_C * a[6];
#            else
#                AC = 0;
#
#            if (a[7] != 0.0)
#                AH2O = (CH_H2O * MACS_ZALUZEC(l, 1) + CO * MACS_ZALUZEC(l, 8))
#                        * D_H2O * a[7];
#            else
#                AH2O = 0;
#
#            eff = exp(-AH2O - AAL - AFORMVAR - AAU - ASID - ABE - AC);
#            return (eff);
#        }
#        else
#        {
...
#    {
#        TSI = a[8];
#        ASI = MACSTOTAL(12.3981f / l, 14) * D_SI * TSI;
#        eff = (1.0f - exp(-ASI));
#
#        return (eff);
#    }
#
#    if (energie > 7.0 && energie < 10.0)
#    {
#        return (1.0);
#    }
#
